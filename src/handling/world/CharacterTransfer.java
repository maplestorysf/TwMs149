...
public class CharacterTransfer implements Externalizable {
    ...
    public int characterid, accountid, exp, fame, pvpExp, pvpPoints,
            ...
            familyid, seniorid, junior1, junior2, currentrep, totalrep, battleshipHP, gachexp, guildContribution, totalWins, totalLosses,onlinetime;
 ...
 /*All custom shit declare here*/
    public int reborns, apstorage, pee, chronosphere, cschronosphere;
    public long[] lastTime;
    public long[] savelastTime;
    public long[] lastSmegaTime;
    public long[] lastASmegaTime;
    public boolean check_msg_BuyMerChant, check_msg_Chat, attackdebug, DebugMessage;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        this.onlinetime = chr.getOnlineTime();
        ...
        this.savelastTime = chr.getCheatTracker().getLastSavespam();
        this.lastSmegaTime = chr.getCheatTracker().getLastSmegaspam();
        this.lastASmegaTime = chr.getCheatTracker().getLastASmegaspam();
        this.characterid = chr.getId();
        this.accountid = chr.getAccountID();
        this.accountname = chr.getClient().getAccountName();
        this.channel = (byte) chr.getClient().getChannel();
        this.ACash = chr.getCSPoints(0);
        ...
        this.pee = chr.getPee();
        this.chronosphere = chr.getChronosphere();
        this.cschronosphere = chr.getCSChronosphere();
        /*End of Custom Feature*/
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.savelastTime = (long[]) in.readObject();
        this.lastSmegaTime = (long[]) in.readObject();
        this.lastASmegaTime = (long[]) in.readObject();
        ...
        this.pee = in.readInt();
        this.chronosphere = in.readInt();
        this.cschronosphere = in.readInt();
        /*End of Custom Feature*/
        ...
        for (int i = 0; i < skillsize; i++) {
            this.Skills.put(in.readInt(), new SkillEntry(in.readInt(), in.readByte(), in.readLong(), -1));
        }
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeObject(this.savelastTime);
        out.writeObject(this.lastSmegaTime);
        out.writeObject(this.lastASmegaTime);
        ...
        out.writeInt(this.chronosphere);
        out.writeInt(this.cschronosphere);
        /*End of Custom Feature*/
