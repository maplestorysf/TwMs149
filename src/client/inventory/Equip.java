...
public class Equip extends Item implements Serializable {
    ...
    private int itemEXP = 0, durability = -1, incSkill = -1, potential1 = 0, potential2 = 0, potential3 = 0, potential4 = 0, potential5 = 0, socket1 = -1, socket2 = -1, socket3 = -1, lockpot = 0,line = 0;
    ...
    public Item copy() {
        ...
        ret.setInventoryId(getInventoryId()); // fix invid = -1
