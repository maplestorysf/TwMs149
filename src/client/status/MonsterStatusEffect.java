...
public class MonsterStatusEffect {
    ...
    private ScheduledFuture<?> poisonSchedule_;
    ...
    public final void setPoisonSchedule(final ScheduledFuture<?> poisonSchedule) {
        this.poisonSchedule_ = poisonSchedule;
    }
    ...
    public final void cancelPoisonSchedule(MapleMonster mm) {
        ...
        this.weakChr = null;
        if (this.poisonSchedule_ != null) {
            try {
                this.poisonSchedule_.cancel(false);
            } catch (NullPointerException e) {
            } //set to null anyway.
        }
        this.poisonSchedule_ = null;
    }
