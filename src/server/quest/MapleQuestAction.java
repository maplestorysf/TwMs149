    ...
    public void runStart(MapleCharacter c, Integer extSelection) {
        ...
        switch (type) {
            case exp:
                ...
                c.gainExp(intStore, true, true, true);
                break;
            case item:
            ...
            case skill:
                ...
                for (Triple<Integer, Integer, Integer> skills : skill) {
                    ...
                    if (skillObject.isBeginnerSkill() || found) {
                        sa.put(skillObject, new SkillEntry((byte) Math.max(skillLevel, c.getSkillLevel(skillObject)), (byte) Math.max(masterLevel, c.getMasterLevel(skillObject)), SkillFactory.getDefaultSExpiry(skillObject), -1));
                    }
                }
