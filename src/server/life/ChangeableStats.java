...
public class ChangeableStats extends OverrideMonsterStats {
    ...
    public ChangeableStats(MapleMonsterStats stats, int newLevel) {//混沌頻道
        final double base = 5;
        ...
        PDRate = Math.min(stats.isBoss() ? 50000 : 30000, (int) Math.round(stats.getPDRate() * base));
        MDRate = Math.min(stats.isBoss() ? 50000 : 30000, (int) Math.round(stats.getMDRate() * base));
