...
public class RandomRewards {
    ...
    private static List<Integer> compiledGold = null, compiledSilver = null, compiledFishing = null, compiledXmas = null, compiledSurpriseStyleBox = null, compiledPeanut = null,
    ...
    static {
        ...
        processRewards(returnArray, GameConstants.xmasReward);

        compiledXmas = returnArray;

        // SurpriseStyleBox Rewards
        returnArray = new ArrayList<>();

        processRewards(returnArray, GameConstants.surpriseStyleBoxReward);

        compiledSurpriseStyleBox = returnArray;
    ...
    public static int getXmasReward() {
        return compiledXmas.get(Randomizer.nextInt(compiledXmas.size()));
    }

    public static int getSurpriseStyleBoxReward() {
        return compiledSurpriseStyleBox.get(Randomizer.nextInt(compiledSurpriseStyleBox.size()));
    }
