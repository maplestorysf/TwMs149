...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        status++;
        if (status == 0)
            cm.sendSimple("您好，我是#p9310016#。如果你有 #b#t5150015##k 或者 #b#t5151011##k，我就能幫你理髮，請選擇服務項目：\r\n#L1#使用 #i5150015##t5150015##l\r\n#L2#使用 #i5151011##t5151011##l");
        else if (status == 1) {
            if (selection == 0) {
                beauty = 0;
                cm.sendSimple("");
                ...
                cm.sendStyle("請選擇你喜歡的造型。", hairnew);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("請選擇你喜歡的造型。", haircolor);
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
                if (cm.haveItem(5150015)) {
                    ...
                    cm.sendOk("您沒有#b#t5150015##k，無法理髮。");
            }
            if (beauty == 2) {
                if (cm.haveItem(5151011)) {
                    ...
                    cm.sendOk("您沒有#b#t5151011##k，無法理髮。");
            }
        }
    }
}