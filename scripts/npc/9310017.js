...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("嗨，我是#p9310017#。如果你有 #b#t5150014##k 或者 #b#t5151010##k，我就可以幫你弄出好看的頭髮。 \r\n#L0#使用 #i5150014##t5150014##l\r\n#L1#使用 #i5151010##t5151010##l");
    } else if (status == 1) {
        if (selection == 0) {
            ...
            cm.sendYesNo("確定要使用 #b#t5150014##k 隨機剪髮嗎？");
            ...
            cm.sendYesNo("確定要使用 #b#t5151010##k 隨機染髮了嗎？");
        }
    } else if (status == 2) {
        if (beauty == 1) {
            if (cm.setRandomAvatar(5150014, hair_Colo_new) == 1) {
                ...
                cm.sendOk("您沒有#b#t5150014##k，無法理髮。");
            }
        } else {
            if (cm.setRandomAvatar(5151010, hair_Colo_new) == 1) {
                cm.sendOk("理髮成功！");
            } else {
                cm.sendOk("您沒有#b#t5151010##k，無法理髮。");
            }
        }
        cm.safeDispose();
    }
