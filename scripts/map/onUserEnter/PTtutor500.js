...
function action(mode, type, selection) {
    ...
    if (status <= i++) {
        ...
        ms.showScreenAutoLetterBox(false, "phantom/mapname3");
        ms.exceTime(3000);
    } else if (status === i++) {
        ...
        ms.showScreenAutoLetterBox(false, "phantom/hillah");
        ms.playSound("Magatia/alceCircle");
        ms.exceTime(1200);
    } else if (status === i++) {
        ms.spawnNPCRequestController(1402400, -131, -7, 1, 2478043);
        ms.spawnNPCRequestController(1402401, -209, -7, 1, 2478044);
        ms.spawnNPCRequestController(1402401, -282, -7, 1, 2478045);
        ms.spawnNPCRequestController(1402401, -59, -7, 1, 2478046);
        ms.playerWaite();
        ms.exceTime(4500);
    } else if (status === i++) {
        ...
        ms.showScreenAutoLetterBox(false, "phantom/skaia");
        ...
        ms.showScreenAutoLetterBox(false, "phantom/phantom");
        ms.playerWaite();
        ms.exceTime(1500);
    } else if (status === i++) {
        ms.sendOthersTalk("還沒到下結論的時候吧?", 1402400, [false, true], 17);
    } else if (status === i++) {
		ms.playMovie("phantom.avi", true);
    } else if (status === i++) {
        ms.exceTime(500);
    } else if (status === i++) {
        ms.forceStartQuest(25001, "1");
        ms.lockUI(false);
        ms.removeNPCRequestController(2478043);
        ms.removeNPCRequestController(2478044);
        ms.removeNPCRequestController(2478045);
        ms.removeNPCRequestController(2478046);
        ms.forceStartQuest(25010, "0");
        ms.dispose();
        ms.warp(150000000, 2);
    } else {
        ms.dispose();
